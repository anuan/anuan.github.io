import"../chunks/DsnmJJEf.js";import"../chunks/C3ZzvBFu.js";import{X as i,_ as t}from"../chunks/DfvMeyEu.js";/* empty css                */var n=i(`<main><h1>Our Vision: A New Paradigm for Shared Decision-Making</h1> <p>Modern medicine has access to more data than ever before. Yet, for both patients and clinicians,
		...
		short of the promise of truly personalized medicine.</p> <h2>Our Solution: Modeling What Truly Drives the Data</h2> <p>We propose a paradigm shift: instead of just learning from data, we start by modeling <i>what drives the data</i>. We build a causal blueprint—a story of the relationships and interdependencies between
		variables—informed by deep clinical knowledge and biological principles.</p> <p>This causal framework acts as "guardrails" for our AI. It allows us to:</p> <ul><li><b>Mitigate Bias:</b> Proactively identify and control for sources of confounding and bias, leading
			...
			and settings because they are based on stable, underlying mechanisms.</li> <li><b>Enable "What If" Scenarios:</b> Reliably estimate the effect of interventions and compare
			different treatment strategies, empowering clinicians to explore possibilities.</li> <li><b>Provide Built-in Interpretability:</b> Offer transparent, explainable predictions that align with
			clinical logic and foster trust.</li></ul> <p>By embedding a causal story at the core of our platform, we move from reactive pattern-matching
		to proactive, mechanism-based prediction. This is the foundation of <b>Causal AI</b>.</p> <h2>How It Works: A Use Case</h2> <p>Imagine Sarah, a 55-year-old newly diagnosed with Type 2 Diabetes. She has questions: <i>"How will this affect my life? What are my options? What happens if I focus on diet versus
			...
			treatment plans. It's not just a prediction; it's a comparison of causal effects.</li> <li><b>Shared Decision-Making:</b> Together, Sarah and her clinician review the potential outcomes. The
			visual and intuitive interface helps Sarah understand the trade-offs, allowing her to
			co-author a treatment plan that aligns with her personal goals and values.</li></ol> <p>This is not about replacing clinical judgment. It's about augmenting it with powerful,
		...
		expertise. Our development process is designed to be inherently collaborative:</p> <ol><li><b>Develop the Causal Story:</b> We bring together clinicians, epidemiologists, and biomedical
			...
			process.</li> <li><b>Gather Targeted Data:</b> The causal graph tells us what data is most important. This allows us
			to be strategic, gathering the <i>right</i> data, not just <i>more</i> data, to answer the most critical
			questions.</li> <li><b>Build the Causal AI Model:</b> Our data scientists then use this causal "scaffolding" to build
			the computational model, ensuring it respects the established biological and clinical logic.</li> <li><b>Refine and Iterate:</b> The model is continuously tested, refined, and updated with new data and
			insights from all stakeholders, including patients.</li></ol> <p>We are actively seeking collaborators to join us on this journey. If you are a clinician,
