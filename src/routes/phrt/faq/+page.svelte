<main>
	...
	<div class="q_and_a">
		...
		<answer>
			...
			<p>Nodes represent variables (e.g., gene mutations, treatments, outcomes).</p>
			<p>Arrows represent direct causal influences (e.g., treatment → biomarker change).</p>
			<p>Structure encodes which factors are causes, which are effects, and which are unrelated.</p>
			<p>
